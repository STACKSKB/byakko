...
fn read_settings_on_device(device: &HidDevice) -> Result<crate::nia87::settings::Settings> {
...
fn lighting_restore_report(original: &crate::nia87::lighting::Lighting) -> [u8; 64] {
