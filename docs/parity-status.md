...
| Local configurations | Keymap draft and macro JSON import/export; full raw archive capture/inspection includes all50 macros, keymaps, current picture, lighting/settings; two complete hardware captures match | Complete archive apply/recovery semantics and GUI interaction coverage; independent picture-bank identification |
