...
| Plug-and-play Nia87 TKL | Attached device auto-loads built-in 87-key geometry and fixed slots; initial discovery retries after read failure with bounded backoff | Stronger board/revision identification, reconnect and multiple-device behavior; clean-machine run |
